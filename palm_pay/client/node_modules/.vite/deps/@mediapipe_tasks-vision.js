...
function c(t2) {
  if (a)
    t2 = (o || (o = new TextEncoder())).encode(t2);
  else {
    let n2 = 0;
...
var u;
t: {
  for (l = ["CLOSURE_FLAGS"], d = t, f = 0; f < l.length; f++)
    if (null == (d = d[l[f]])) {
      u = null;
      break t;
    }
...
var N = class {
  ...
  constructor(t2, e2) {
    if (j(e2), this.g = t2, null != t2 && 0 === t2.length)
...
function ft(t2, e2) {
  if (null != t2) {
    if ("string" == typeof t2)
      t2 = t2 ? new N(t2, C) : U();
    else if (t2.constructor !== N)
      if (O(t2))
        t2 = t2.length ? new N(new Uint8Array(t2), C) : U();
      else {
        if (!e2)
          throw Error();
        t2 = void 0;
...
function Gt(t2, e2) {
  if (t2 >>>= 0, (e2 >>>= 0) <= 2097151)
    ...
    ot() ? n2 = "" + (BigInt(e2) << BigInt(32) | BigInt(t2)) : (t2 = (16777215 & t2) + 6777216 * (n2 = 16777215 & (t2 >>> 24 | e2 << 8)) + 6710656 * (e2 = e2 >> 16 & 65535), n2 += 8147497 * e2, e2 *= 2, t2 >= 1e7 && (n2 += t2 / 1e7 >>> 0, t2 %= 1e7), n2 >= 1e7 && (e2 += n2 / 1e7 >>> 0, n2 %= 1e7), n2 = e2 + jt(n2) + jt(t2));
  return n2;
}
function jt(t2) {
...
function se(t2) {
  ...
  var e2 = typeof t2;
  if ("bigint" === e2)
    return String(Wt(64, t2));
  if (Zt(t2)) {
    if ("string" === e2)
      return e2 = Yt(Number(t2)), zt(e2) && e2 >= 0 ? t2 = String(e2) : (-1 !== (e2 = t2.indexOf(".")) && (t2 = t2.substring(0, e2)), ee(t2) || (Vt(t2), t2 = Gt(Pt, Ot))), t2;
    if ("number" === e2)
      return (t2 = Yt(t2)) >= 0 && zt(t2) ? t2 : function(t3) {
        if (t3 < 0) {
          Ut(t3);
          var e3 = Gt(Pt, Ot);
...
function he(t2, e2, n2, r2) {
  if (null != t2 && "object" == typeof t2 && t2.W === ht)
    return t2;
  if (!Array.isArray(t2))
    return n2 ? 2 & r2 ? ((t2 = e2[Y]) || (rt((t2 = new e2()).u), t2 = e2[Y] = t2), e2 = t2) : e2 = new e2() : e2 = void 0, e2;
  let i2 = n2 = 0 | t2[Z];
...
function ke(t2, e2, n2, r2, i2) {
  if (null != t2) {
    if (Array.isArray(t2))
      t2 = pt(t2) ? void 0 : i2 && 2 & (0 | t2[Z]) ? t2 : Se(t2, e2, n2, void 0 !== r2, i2);
    else if (dt(t2)) {
      const s2 = {};
      for (let o2 in t2)
        s2[o2] = ke(t2[o2], e2, n2, r2, i2);
      t2 = s2;
    } else
      t2 = e2(t2, r2);
    return t2;
...
function Ie(t2, e2, n2, r2) {
  if (null == t2) {
    ...
    t: {
      ...
      if (e2) {
        if ((e2 = Math.max(e2, r2 - (512 & i2 ? 0 : -1))) > 1024)
          throw Error("spvt");
        i2 = -33521665 & i2 | (1023 & e2) << 15;
      }
    }
...
function Qe(t2, e2, n2, r2) {
  let i2, s2 = 0 | t2[Z];
  if (null != (r2 = Ue(t2, s2, n2, r2)) && r2.W === ht)
    return (e2 = Oe(r2)) !== r2 && Ne(t2, s2, n2, e2), e2.u;
  if (Array.isArray(r2)) {
    const t3 = 0 | r2[Z];
    i2 = 2 & t3 ? Fe(Pe(r2, t3, false), e2, true) : 64 & t3 ? r2 : Fe(i2, e2, true);
  } else
    i2 = Fe(void 0, e2, true);
...
function nn(t2, e2, n2, r2, i2, s2, o2) {
  ...
  if (o2 && !(8 & h2 || !i2.length && (1 === c2 || 4 === c2 && 32 & h2))) {
    for (We(h2) && (i2 = at(i2), h2 = an(h2, e2), e2 = Ne(t2, e2, r2, i2)), n2 = i2, o2 = h2, u2 = 0; u2 < n2.length; u2++)
      (h2 = n2[u2]) !== (l = Oe(h2)) && (n2[u2] = l);
...
function wn(t2) {
  ...
  if (t2.constructor === ArrayBuffer)
    return { buffer: new Uint8Array(t2), N: false };
  if (t2.constructor === N)
    return { buffer: D(t2) || new Uint8Array(0), N: true };
    ...
    if (h2) {
      ...
      if (r2) {
        t: {
          ...
          if (o2)
            for (let t3 in o2)
              isNaN(+t3) ? (s2 ?? (s2 = {}))[t3] = o2[t3] : (r2 = o2[t3], Array.isArray(r2) && (pt(r2) || lt(r2) && 0 === r2.size) && (r2 = null), null == r2 && (a2 = true), null != r2 && ((s2 ?? (s2 = {}))[t3] = r2));
          if (a2 || (s2 = o2), s2)
            for (let t3 in s2) {
              a2 = s2;
              break t;
      ...
      for (; h2 > 0 && (null == (s2 = i2[h2 - 1]) || pt(s2) || lt(s2) && 0 === s2.size); h2--)
        var c2 = true;
...
function Rr(t2, e2, n2, r2) {
  ...
  for (c2 = 1; void 0 !== s2; ) {
    ...
    var h2 = void 0;
    if (s2 instanceof _r ? t3 = s2 : (t3 = wr, o2--), t3 == null ? void 0 : t3.l) {
      s2 = r2[++o2], h2 = r2;
      var u2 = o2;
...
function Br(t2, e2, n2) {
  ...
  if (256 & r2) {
    r2 = t2[s2 - 1];
    for (const t3 in r2)
      i2 = +t3, Number.isNaN(i2) || null != (s2 = r2[i2]) && (a2 = Gr(n2, i2)) && a2(e2, s2, i2);
  }
  if (t2 = _t(t2))
    for (nr(e2, e2.g.end()), n2 = 0; n2 < t2.length; n2++)
      nr(e2, D(t2[n2]) || new Uint8Array(0));
}
function Gr(t2, e2) {
  var n2 = t2[e2];
  if (n2)
  ...
  g() {
    ...
    return t2 = function(t3, e3, n3) {
      ...
      if (null == n3) {
        ...
        Array.isArray(n3) ? s2 = !!(2 & (0 | n3[Z])) : n3 = [];
      if (i2) {
        if (!n3.length)
          return be();
        s2 || (s2 = true, rt(n3));
      } else
        s2 && (s2 = false, n3 = ze(n3));
...
function bo(t2) {
  ...
  if ((e2 = (_a2 = en(t2, ss, 4)) == null ? void 0 : _a2.h()) && (s2.boundingBox = { originX: un(e2, 1) ?? 0, originY: un(e2, 2) ?? 0, width: un(e2, 3) ?? 0, height: un(e2, 4) ?? 0, angle: 0 }), (_b = en(t2, ss, 4)) == null ? void 0 : _b.g().length)
    for (const e3 of en(t2, ss, 4).g())
      s2.keypoints.push({ x: Be(e3, 1) ?? 0, y: Be(e3, 2) ?? 0, score: Be(e3, 4) ?? 0, label: ln(e3, 3) ?? "" });
  return s2;
}
function ko(t2) {
  const e2 = [];
  for (const n2 of rn(t2, hs, 1))
    e2.push({ x: dn(n2, 1) ?? 0, y: dn(n2, 2) ?? 0, z: dn(n2, 3) ?? 0, visibility: dn(n2, 4) ?? 0 });
  return e2;
}
function So(t2) {
  const e2 = [];
  for (const n2 of rn(t2, as, 1))
    e2.push({ x: dn(n2, 1) ?? 0, y: dn(n2, 2) ?? 0, z: dn(n2, 3) ?? 0, visibility: dn(n2, 4) ?? 0 });
  return e2;
}
function xo(t2) {
...
async function Vo(t2, e2, n2, r2) {
  return t2 = await (async (t3, e3, n3, r3, i2) => {
    if (e3 && await Co(e3), !self.ModuleFactory)
      throw Error("ModuleFactory not set.");
    if (n3 && (await Co(n3), !self.ModuleFactory))
      throw Error("ModuleFactory not set.");
...
function Ho(t2) {
  try {
    ...
    if (1 === e2)
      throw Error(t2.G[0].message);
    if (e2 > 1)
      throw Error("Encountered multiple errors: " + t2.G.map((t3) => t3.message).join(", "));
  } finally {
    t2.G = [];
  }
}
...
var $o = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c2 = en(this.baseOptions, xs, 1)) == null ? void 0 : _c2.g()) || ((_d = en(this.baseOptions, xs, 1)) == null ? void 0 : _d.h()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath)))
...
var sa = class {
  ...
  m() {
    const t2 = this.g;
    if (this.h = qo(t2.createProgram(), "Failed to create WebGL program"), this.aa = Zo(this, "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }", t2.VERTEX_SHADER), this.Z = Zo(this, this.G(), t2.FRAGMENT_SHADER), t2.linkProgram(this.h), !t2.getProgramParameter(this.h, t2.LINK_STATUS))
...
var La = class {
  ...
  ya(t2, e2) {
    if (t2) {
      ...
      for (const s2 of t2)
        n2.fillStyle = wa(e2.fillColor, { index: i2, from: s2 }), n2.strokeStyle = wa(e2.color, { index: i2, from: s2 }), n2.lineWidth = wa(e2.lineWidth, { index: i2, from: s2 }), (t2 = new Path2D()).arc(s2.x * r2.width, s2.y * r2.height, wa(e2.radius, { index: i2, from: s2 }), 0, 2 * Math.PI), n2.fill(t2), n2.stroke(t2), ++i2;
      n2.restore();
    }
  }
  xa(t2, e2, n2) {
...
function Ha(t2, e2, n2, r2) {
  if (t2.T) {
    ...
    if (n2 == null ? void 0 : n2.rotationDegrees) {
      ...
      if (gn(s2, 5, -Math.PI * n2.rotationDegrees / 180), (n2 == null ? void 0 : n2.rotationDegrees) % 180 != 0) {
        const [t3, r3] = Uo(e2);
...
var Ya = class extends $o {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && fn(this.baseOptions, 2, !!t2.runningMode && "IMAGE" !== t2.runningMode), void 0 !== t2.canvas && this.g.i.canvas !== t2.canvas)
...
var $a = class extends Ya {
  ...
  m() {
    ...
    Gi(n2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"), ji(n2, "IMAGE:image_in"), ji(n2, "NORM_RECT:norm_rect_in"), Vi(n2, "DETECTIONS:detections"), n2.o(e2), Ki(t2, n2), this.g.attachProtoVectorListener("detections", (t3, e3) => {
      for (const e4 of t3)
        t3 = os(e4), this.j.detections.push(bo(t3));
      Wo(this, e3);
...
var ac = class extends Ya {
  ...
  m() {
    ...
    Gi(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), ji(n2, "IMAGE:image_in"), ji(n2, "NORM_RECT:norm_rect"), Vi(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), Ki(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = us(e4), this.j.faceLandmarks.push(ko(t3));
      Wo(this, e3);
      ...
      if (this.outputFaceBlendshapes)
        for (const e4 of t3)
          t3 = ns(e4), this.j.faceBlendshapes.push(Ao(t3.g() ?? []));
      Wo(this, e3);
      ...
      if (this.outputFacialTransformationMatrixes)
        for (const e4 of t3)
          (t3 = en(Os(e4), ls, 2)) && this.j.facialTransformationMatrixes.push({ rows: un(t3, 1) ?? 0 ?? 0, columns: un(t3, 2) ?? 0 ?? 0, data: Ve(t3, 3, $t, je()).slice() ?? [] });
      Wo(this, e3);
...
var cc = class extends Ya {
  ...
  Oa(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, Wa(this, t2, r2 ?? {}), !this.h)
      return this.s;
  }
  m() {
    var t2 = new qi();
...
function dc(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && null != un(n3, 1) ? un(n3, 1) ?? 0 : -1, t2.push({ score: dn(n3, 2) ?? 0, index: r2, categoryName: ln(n3, 3) ?? "" ?? "", displayName: ln(n3, 4) ?? "" ?? "" });
    n2.push(t2);
  }
  return n2;
}
var fc = class extends Ya {
  ...
  o(t2) {
    ...
    if (pn(this.v, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && gn(this.v, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && gn(this.s, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && gn(this.C, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new Vs(), n2 = e2, r2 = To(t2.cannedGesturesClassifierOptions, (_a2 = en(this.h, Vs, 3)) == null ? void 0 : _a2.h());
      sn(n2, 0, 2, r2), sn(this.h, 0, 3, e2);
    } else
      void 0 === t2.cannedGesturesClassifierOptions && ((_b = en(this.h, Vs, 3)) == null ? void 0 : _b.g());
    return t2.customGesturesClassifierOptions ? (sn(n2 = e2 = new Vs(), 0, 2, r2 = To(t2.customGesturesClassifierOptions, (_c2 = en(this.h, Vs, 4)) == null ? void 0 : _c2.h())), sn(this.h, 0, 4, e2)) : void 0 === t2.customGesturesClassifierOptions && ((_d = en(this.h, Vs, 4)) == null ? void 0 : _d.g()), this.l(t2);
  }
  Ja(t2, e2) {
  ...
  m() {
    ...
    Gi(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), ji(n2, "IMAGE:image_in"), ji(n2, "NORM_RECT:norm_rect"), Vi(n2, "HAND_GESTURES:hand_gestures"), Vi(n2, "LANDMARKS:hand_landmarks"), Vi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Vi(n2, "HANDEDNESS:handedness"), n2.o(e2), Ki(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3) {
        t3 = us(e4);
        const n3 = [];
        for (const e5 of rn(t3, hs, 1))
          n3.push({ x: dn(e5, 1) ?? 0, y: dn(e5, 2) ?? 0, z: dn(e5, 3) ?? 0, visibility: dn(e5, 4) ?? 0 });
...
var gc = class extends Ya {
  ...
  m() {
    ...
    Gi(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), ji(n2, "IMAGE:image_in"), ji(n2, "NORM_RECT:norm_rect"), Vi(n2, "LANDMARKS:hand_landmarks"), Vi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), Vi(n2, "HANDEDNESS:handedness"), n2.o(e2), Ki(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = us(e4), this.landmarks.push(ko(t3));
      Wo(this, e3);
    }), this.g.attachEmptyPacketListener("hand_landmarks", (t3) => {
      Wo(this, t3);
    }), this.g.attachProtoVectorListener("world_hand_landmarks", (t3, e3) => {
      for (const e4 of t3)
        t3 = cs(e4), this.worldLandmarks.push(So(t3));
      Wo(this, e3);
    }), this.g.attachEmptyPacketListener("world_hand_landmarks", (t3) => {
      Wo(this, t3);
    }), this.g.attachProtoVectorListener("handedness", (t3, e3) => {
      ...
      for (const e4 of t3) {
        ...
        for (const e5 of t3.g())
          n4.push({ score: dn(e5, 2) ?? 0, index: un(e5, 1) ?? 0 ?? -1, categoryName: ln(e5, 3) ?? "" ?? "", displayName: ln(e5, 4) ?? "" ?? "" });
        i2.push(n4);
      }
    ...
    Ke(n2, 1, ae("type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"), ""), function(t3, e3) {
      if (null != e3)
        if (Array.isArray(e3))
          ...
          if (!("string" == typeof e3 || e3 instanceof N || O(e3)))
...
var wc = class extends Ya {
  ...
  m() {
    ...
    Gi(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), ji(n2, "IMAGE:input_image"), ji(n2, "NORM_RECT:norm_rect"), Vi(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), Ki(t2, n2), this.g.attachProtoListener("classifications", (t3, e3) => {
      this.j = function(t4) {
        const e4 = { classifications: rn(t4, ps, 1).map((t5) => {
          var _a2;
          return Ao(((_a2 = en(t5, ts, 4)) == null ? void 0 : _a2.g()) ?? [], un(t5, 2) ?? 0, ln(t5, 3) ?? "");
        }) };
    ...
    Gi(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), ji(n2, "IMAGE:image_in"), ji(n2, "NORM_RECT:norm_rect"), Vi(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), Ki(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = Es(t3), this.embeddings = function(t4) {
        return { embeddings: rn(t4, _s, 1).map((t5) => {
          ...
          if (void 0 !== tn(t5, ms, $e(t5, 1)))
            t5 = Ve(t5 = en(t5, ms, $e(t5, 1)), 1, $t, je()), e4.floatEmbedding = t5.slice();
          else {
            const n3 = new Uint8Array(0);
            e4.quantizedEmbedding = ((_b = (_a2 = en(t5, ys, $e(t5, 2))) == null ? void 0 : _a2.oa()) == null ? void 0 : _b.h()) ?? n3;
          }
          return e4;
...
Tc.cosineSimilarity = function(t2, e2) {
  if (t2.floatEmbedding && e2.floatEmbedding)
    t2 = Lo(t2.floatEmbedding, e2.floatEmbedding);
  else {
...
var Sc = class extends Ya {
  ...
  I() {
    !function(t2) {
      ...
      1 === e2.length && (((_b = (_a2 = en(e2[0], Di, 7)) == null ? void 0 : _a2.l()) == null ? void 0 : _b.g()) ?? /* @__PURE__ */ new Map()).forEach((e3, n2) => {
...
var Bc = class extends Ya {
  ...
  segment(t2, e2, n2, r2) {
    ...
    const s2 = new Uc();
    var o2 = new Lc();
    if (pn(o2, 1, 255), sn(s2, 0, 12, o2), e2.keypoint && e2.scribble)
    ...
    if (e2.keypoint) {
      ...
      for (a2 of (o2 = new Cc(), e2.scribble))
        fn(e2 = new Pc(), 3, true), gn(e2, 1, a2.x), gn(e2, 2, a2.y), hn(o2, 1, Pc, e2);
      on(s2, 15, Dc, o2);
    }
